...
\\(\delta^{[2]}=dA^{[2]} \odot g^{'[2]}=\begin{bmatrix}da_{11}^{[2]} & da_{12}^{[3]}\end{bmatrix}\\) \odot \begin{bmatrix}
g^{'}(z_{11}^{[2]}) & g^{'}z_{12}^{[2]})\\\\\\
g^{'}(z_{21}^{[2]}) & g^{'}(z_{22}^{[2]})\\\\\\
g^{'}(z_{31}^{[2]})& g^{'}(z_{32}^{[2]})
\end{bmatrix}=\begin{bmatrix}
a^{[2]} \cdot g^{'}(z_{11}^{[2]}) & a^{[2]} \cdot g^{'}z_{12}^{[2]}) \\\\\\
a^{[2]} \cdot g^{'}(z_{21}^{[2]}) & a^{[2]} \cdot g^{'}(z_{22}^{[2]})\\\\\\
a^{[2]} \cdot g^{'}(z_{31}^{[2]})& a^{[2]} \cdot g^{'}(z_{32}^{[2]})
\end{bmatrix}\\)
