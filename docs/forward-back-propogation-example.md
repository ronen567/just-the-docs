...
g^{'}(z_{31}^{[2]})& g^{'}(z_{32}^{[2]})
\end{bmatrix}=\begin{bmatrix}
da_11^{[2]} \cdot g^{'}(z_{11}^{[2]}) & da_12^{[2]} \cdot g^{'}z_{12}^{[2]}) \\\\\\
da_21^{[2]} \cdot g^{'}(z_{21}^{[2]}) & da_22^{[2]} \cdot g^{'}(z_{22}^{[2]})\\\\\\
da_31^{[2]} \cdot g^{'}(z_{31}^{[2]}) & da_32^{[2]} \cdot g^{'}(z_{32}^{[2]})
\end{bmatrix}
=
\begin{bmatrix}
\delta^{[2]} & da_12^{[2]} \cdot g^{'}z_{12}^{[2]}) \\\\\\
da_21^{[2]} \cdot g^{'}(z_{21}^{[2]}) & da_22^{[2]} \cdot g^{'}(z_{22}^{[2]})\\\\\\
da_31^{[2]} \cdot g^{'}(z_{31}^{[2]}) & da_32^{[2]} \cdot g^{'}(z_{32}^{[2]})
\end{bmatrix}\\)
